...
public final class QueryUtils {
    ...
    public static ArrayList<earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONObject basejsonrespose = new JSONObject(SAMPLE_JSON_RESPONSE);//this class will parse the whole geo json string
            JSONArray earthquakearray = basejsonrespose.getJSONArray("features");

            for(int i = 0;i<earthquakearray.length();i++)
            {
                JSONObject currentObj = earthquakearray.getJSONObject(i);
                JSONObject property = currentObj.getJSONObject("properties");
                ...
                earthquake earthquak = new earthquake(magnitude,time,location,url);
                earthquakes.add(earthquak);
            }
